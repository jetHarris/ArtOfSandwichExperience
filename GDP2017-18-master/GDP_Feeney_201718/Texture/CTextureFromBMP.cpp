...
//bool CTextureFromBMP::CreateNewTextyreFromBMPFileSOIL( std::string textureName, std::string fileNameFullPath, bool bGenerateMIPMap )
//{
...
bool CTextureFromBMP::CreateNewTextureFromBMPFileNoFilter(std::string textureName, std::string fileNameFullPath, bool bGenerateMIPMap)
{
	bool bReturnVal = true;
